...
OBSERVATION_COLUMNS = [
    ...
    "quality.code_valid",
    "quality.phase_valid",
    "tracking.half_cycle_ambiguity",
    "tracking.half_cycle_subtracted",
    "tracking.continuity_counter",
    "tracking.continuity_counter_modulus",
    "tracking.lock_duration_s",
    "tracking.lock_duration_is_lower_bound",
