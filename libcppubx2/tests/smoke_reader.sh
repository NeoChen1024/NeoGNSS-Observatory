...
# The two frames are a zero-payload frame and NAV-EOE without NAV-TIMEGPS.
if printf '\265\265\142\001\002\000\000\003\012\265\142\001\141\004\000\000\000\000\000\146\307' |
	"$logger" -n -q 2>"$tmp"; then
	exit 1
fi
...
grep -q 'EOE requires matching valid NAV-TIMEGPS' "$tmp"

if printf '\265\142\001\141\004\000\000\000\000\000\146\307' |
	"$logger" -n -d 2>"$tmp"; then
	exit 1
fi
